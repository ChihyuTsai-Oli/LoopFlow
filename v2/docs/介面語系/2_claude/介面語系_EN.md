# LoopFlow 2.0 — 介面語系（Codex 英文草稿，Claude 校對版）

Claude 校對 `1_codex/介面語系_EN.md` 後存於此。校對重點：拼字統一為 cancelled（雙 L，非美式 canceled）、彎引號改直引號、還原被 Codex 誤改的原已核可欄位、統一 nexus_metadata.047–056 欄名大小寫並修正 .056 語序。
