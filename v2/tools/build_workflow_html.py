...
執行
    python v2/tools/build_workflow_html.py
    python v2/tools/build_workflow_html.py --src <來源.md> --out <輸出.html>
    python v2/tools/build_workflow_html.py --check    # 只檢查是否過期，不寫檔
...
# 專案內的預設位置：<repo>/v2/tools/ → <repo>/v2/docs/
