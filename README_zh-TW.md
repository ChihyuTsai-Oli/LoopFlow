...
1. 開啟 Rhino 8，命令列執行 `PackageManager`，搜尋 `LoopFlow`，安裝 2.0.2
2. **完全關掉 Rhino 再開**

也可從 [Releases](https://github.com/ChihyuTsai-Oli/LoopFlow/releases/latest) 下載 `loopflow-2.0.2-rh8_0-win.yak`，在 Package Manager 選擇從檔案安裝。不要下載 1.x 的 ZIP。
