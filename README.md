...
1. Download the LoopFlow 1.0.0 ZIP from the [v1.0.0 release](https://github.com/ChihyuTsai-Oli/LoopFlow/releases/tag/v1.0.0) (file: LoopFlow_v1.0.0.zip). Do not use GitHub Latest; that is 2.0.
