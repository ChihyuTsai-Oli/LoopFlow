...
剩餘開發順序：**Document。** Extract CP **公司 Rhino 8 已測（2026-08-20）**。Duplicate Layout **家中 Rhino 8 已測（2026-08-20）**。Sync Worksession **家中 Rhino 8 已測（2026-08-20）**。

| 指令 | 用途 | 狀態 |
|---|---|---|
| `LF_Sync_Worksession` | 監看與更新 Worksession | 家中 Rhino 8 已測（2026-08-20） |
