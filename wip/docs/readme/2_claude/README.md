...
| Rhino | **8**（必要，非選配） |
| 作業系統 | Windows |
| 版本混用 | **不可**與 LoopFlow 1.x 的資料、工具列或指令混用 |
...
| OS | Windows |
| Version mixing | **Do not** mix its data, toolbars, or commands with LoopFlow 1.x |
...
英文版將在繁中版定案後翻譯。目前四份文件皆為草稿，內容以已完成並實機驗證的 2.0 功能為準。

The English versions will be translated once the Traditional Chinese versions are finalized. All four documents below are drafts, describing the LoopFlow 2.0 features that are implemented and have passed on-machine verification.
