...
1. Open Rhino 8, run `PackageManager`, search for `LoopFlow`, and install 2.0.2.
2. **Quit Rhino completely and reopen it.**

You can also download `loopflow-2.0.2-rh8_0-win.yak` from [Releases](https://github.com/ChihyuTsai-Oli/LoopFlow/releases/latest) and install from file. Do not download the 1.x ZIP.
